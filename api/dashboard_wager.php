...
require_login();
$user = current_user();
if ($user['role'] !== 'wager') { header('Location: login.php'); exit; }
...
// Handle new achievement submission
...
<head>
  ...
  <title>Wager Dashboard - SConnect</title>
  ...
  <div class="header">
    <div class="header-content">
      ...
      <div class="header-nav">
        <button class="header-btn" onclick="location.href='dashboard_wager.php'">
    ...
    <div class="feed">
      ...
      <div class="create-post">
        <div class="create-post-header">
          ...
          <input type="text" class="create-post-input" placeholder="Share your latest achievement..." 
  ...
  <div id="createModal" class="modal">
    <div class="modal-content">
      <div class="modal-header">
        <div class="modal-title">Add New Achievement</div>
      ...
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label class="form-label">Attachment (Image or File)</label>
